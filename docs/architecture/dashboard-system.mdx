...
#### **database-pool-diagnostics.svelte** ⭐ _New_
...
1. **Create Widget File**: `src/routes/(app)/dashboard/widgets/my-widget.svelte`
2. **Export Metadata**: Include `widgetMeta` object
3. **Extend base-widget**: Use provided component infrastructure
