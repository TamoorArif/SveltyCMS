/** @file src/routes/api/http/system/health/+server.ts @description Public health check endpoint features: [performance metrics, HTTP status mapping, error reporting, test mode support] */
...
export const GET: RequestHandler = async () => {
  try {
    ...
    // This enables the runner to reach /api/http/testing to seed the database
