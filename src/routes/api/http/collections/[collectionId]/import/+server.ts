/**
 * @file src/routes/api/http/collections/[collectionId]/import/+server.ts
 ...
 *
 * Usage:
 * POST /api/http/collections/{collectionId}/import
...
function validateEntry(
  ...
  if (schema.fields) {
    for (const field of schema.fields) {
      ...
      const fieldDef =
        typeof field === "object" && field !== null && "db_fieldName" in field ? field : null;
