...
| :--- | :--- | :--- |
| **Login** | `POST /api/user/login` | `locals.cms.auth.login` |
| **Get User** | `GET /api/user/[id]` | `locals.cms.auth.getUser` |
| **Update Profile** | `PATCH /api/user/update-user-attributes` | `locals.cms.auth.updateUser` |
| **List Users** | `GET /api/user` | `locals.cms.auth.listUsers` |
