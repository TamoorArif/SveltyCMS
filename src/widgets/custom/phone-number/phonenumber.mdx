...
description: "Phone number input widget with E.164 validation, custom patterns, and semantic mobile keyboards."
order: 3
...
- [Number Widget](../number/number.mdx) - For numeric values (NOT for phone numbers!)
