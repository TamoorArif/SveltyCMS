...
| **Real-time Sync**  | **SSE Push (Zero-Latency)** | WebSockets         | None / Custom      | WebSockets         |
| **Cache Repair**    | **Smart / Incremental**     | Manual Clear       | Manual Clear       | Manual Clear       |
| **SDK Latency**     | **Zero (Local Bridge)**     | 2–5ms (Local HTTP) | ~1ms (Direct)      | 3–8ms (Local HTTP) |
