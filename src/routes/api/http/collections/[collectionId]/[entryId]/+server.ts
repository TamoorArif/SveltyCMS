/**
 * @file src/routes/api/http/collections/[collectionId]/[entryId]/+server.ts
 * @description API endpoint for updating and deleting a single collection entry
 *
 * @example PATCH/DELETE /api/http/collections/:collectionId/:entryId
 *
 * Features:
...
export const PATCH = apiHandler(async ({ locals, params, request }) => {
  ...
  await cacheService
    .clearByPattern(cachePattern, tenantId)
