...
import { CacheCategory } from './cache-category';
 ...
 */
// CacheCategory enum now imported from ./cache-category.ts
...
const DEFAULT_CATEGORY_TTLS: Record<CacheCategory, number> = {
	...
	[CacheCategory.COLLECTION]: 600, // 10 minutes
	[CacheCategory.ENTRY]: 180, // 3 minutes
	[CacheCategory.SETTING]: 3600 // 1 hour
};
