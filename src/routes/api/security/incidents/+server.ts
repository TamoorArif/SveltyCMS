...
import { any, ip, literal, maxValue, minLength, minValue, number, object, parse, pipe, string, union } from 'valibot';
...
const createIncidentSchema = object({
	...
	severity: pipe(number(), minValue(1, 'Severity must be at least 1'), maxValue(10, 'Severity cannot exceed 10')),
