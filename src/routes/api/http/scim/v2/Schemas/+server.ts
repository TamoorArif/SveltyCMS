/**
 * @file src/routes/api/http/scim/v2/Schemas/+server.ts
...
const USER_SCHEMA = {
  ...
  meta: {
    resourceType: "Schema",
    location: "/api/http/scim/v2/Schemas/urn:ietf:params:scim:schemas:core:2.0:User",
  },
};
...
const GROUP_SCHEMA = {
  ...
  meta: {
    resourceType: "Schema",
    location: "/api/http/scim/v2/Schemas/urn:ietf:params:scim:schemas:core:2.0:Group",
  },
};
