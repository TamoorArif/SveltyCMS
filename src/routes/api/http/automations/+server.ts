/**
 * @file src/routes/api/http/automations/+server.ts
...
/** GET /api/http/automations — List all automation flows for the current tenant */
...
/** POST /api/http/automations — Create a new automation flow */
