---
path: "src/widgets/core/date-range/daterange.mdx"
...
- Input component: `input.svelte` — editor UI with two native date inputs and simple presets.
- Display component: `display.svelte` — renders a compact, localized date-range string plus duration/context.
...
- `index.ts` — component source and validation schema
