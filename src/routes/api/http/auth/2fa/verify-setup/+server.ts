/**
 * @file src/routes/api/http/auth/2fa/verify-setup/+server.ts
 * @description
...
export const POST = apiHandler(async (event: RequestEvent) => {
  ...
  return json({
    success: true,
    message:
      "2FA has been successfully enabled for your account. Please save your backup codes in a secure location.",
  });
});
