...
export const privateConfigSchema = object({
	...
	DB_TYPE: union([literal('mongodb'), literal('mongodb+srv'), literal('mariadb'), literal('postgresql'), literal('sqlite'), literal('')]),
...
export const databaseConfigSchema = object({
	type: union([literal('mongodb'), literal('mongodb+srv'), literal('mariadb'), literal('postgresql'), literal('sqlite')]),
