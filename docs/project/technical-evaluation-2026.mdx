...
- **Security Hardening (Media API):** Implemented native SSRF protection (blocking internal IP ranges), command injection prevention (spawn-based process management), and hardened directory traversal validation for all media operations.
