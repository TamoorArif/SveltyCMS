...
> [!NOTE]
> SQLite is now a fully production-ready adapter using Bun's native driver. MongoDB, MariaDB/MySQL, PostgreSQL, and SQLite are all supported.
...
4. **Multi-Database Support** - Proven support for MongoDB, MariaDB/MySQL, PostgreSQL, and SQLite
