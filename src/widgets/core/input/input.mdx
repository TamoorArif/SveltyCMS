...
| -------------- | -------------------------- | --------------------------------------------------- |
| **Definition** | `index.ts`                 | Widget configuration, validation schema, GUI schema |
| **Input**      | `input.svelte`             | User input component with validation                |
| **Display**    | `display.svelte`           | Read-only display of stored values                  |
...
- [Email Widget](../../custom/email/email.mdx) - For email addresses with format validation
- [Number Widget](../../custom/number/number.mdx) - For numeric values with min/max constraints
- [PhoneNumber Widget](../../custom/phone-number/phonenumber.mdx) - For phone numbers with E.164 validation
