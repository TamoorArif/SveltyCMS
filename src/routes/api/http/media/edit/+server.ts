/**
 * @file src/routes/api/http/media/edit/+server.ts
...
export const POST: RequestHandler = async ({ request, locals }) => {
  try {
    ...
    try {
      ...
      if (
        operations.brightness !== undefined ||
        operations.saturation !== undefined ||
        operations.lightness !== undefined
      ) {
        sharpInstance = sharpInstance.modulate({
          brightness:
            operations.brightness !== undefined ? 1 + operations.brightness / 100 : undefined,
          saturation:
            operations.saturation !== undefined ? 1 + operations.saturation / 100 : undefined,
    ...
    try {
      ...
      if (mediaId && saveBehavior === "overwrite") {
        ...
        savedItem = await mediaService.addVersion(
    ...
    logger.error("Error in /api/http/media/edit:", error);
