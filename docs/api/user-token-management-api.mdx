...
| :--- | :--- | :--- |
| **Create Token** | `POST /api/token/create-token` | `locals.cms.auth.createToken` |
| **List Tokens** | `GET /api/token` | `locals.cms.auth.listTokens` |
| **Revoke Token** | `DELETE /api/token/[id]` | `locals.cms.auth.revokeToken` |
