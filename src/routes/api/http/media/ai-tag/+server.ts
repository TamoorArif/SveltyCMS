/**
 * @file src/routes/api/http/media/ai-tag/+server.ts
...
export const POST: RequestHandler = async ({ request }) => {
  ...
  try {
    ...
    if (!useAi) {
      throw error(
        400,
        "AI Tagging is currently disabled. Please enable it in System Settings and configure your AI API endpoint.",
      );
    }
