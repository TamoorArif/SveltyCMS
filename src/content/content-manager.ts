...
export const contentManager = {
  ...
  isInitializedForTenant: (tenantId: string | null) =>
    contentInitializer.isInitializedForTenant(tenantId),
  ...
  refresh: (tenantId: string | null = null, skipReconciliation = false) =>
    contentInitializer.refresh(tenantId, skipReconciliation),
