/**
 * @file src/routes/api/http/scim/v2/Groups/[id]/+server.ts
...
// GET /api/http/scim/v2/Groups/{id} — Fetch a single group with members
...
// PATCH /api/http/scim/v2/Groups/{id} — Add/remove members
...
// DELETE /api/http/scim/v2/Groups/{id} — Delete group/role
