/** @file src/routes/api/http/system/version/+server.ts @description API endpoint for checking system version and security updates features: [GitHub API integration, in-memory caching, fallback to package.json] */
...
export const GET = apiHandler(async () => {
  ...
  try {
    const response = await fetch(
      "https://api.github.com/repos/SveltyCMS/SveltyCMS/releases/latest",
      {
