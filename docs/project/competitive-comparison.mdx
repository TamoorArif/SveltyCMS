...
| **Throughput**  | **1,150+ RPS** (Concurrent) | ~900-1,200 RPS (Est.) | ~30-50 RPS    | ~50-80 RPS       |
| **Avg Latency** | **42-95 ms** (Under Load)   | ~15 ms (Sequential\*) | 102 ms        | 45 ms            |
| **Cached Path** | **< 10ms** (Hot Paths)      | < 10ms                | ~20ms         | ~15ms            |
| **Edge Ready**  | ✅ Native (5-Pillar Core)   | 🔶 Complex (Next)     | ❌ Restricted | ❌               |
