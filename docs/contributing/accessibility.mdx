...
| :----------------- | :---------------- | :-------- | :--------------------------------------- |
| **Save**           | `Mod + S`         | All       | Universal save (Global, Editor, Builder) |
| **Cancel / Close** | `Escape`          | All       | Standard for modals, dialogs, and tools  |
| **Delete**         | `Delete`          | All       | Remove selected items or fields          |
| **Undo**           | `Mod + Z`         | All       | Native browser + Image Editor standard   |
| **Redo**           | `Mod + Shift + Z` | All       | Standard pairing with undo               |
| **Duplicate**      | `Mod + D`         | All       | Clone selected field (BuzzForm)          |
| **Next Step**      | `Mod + Enter`     | All       | Advance in Steppers / Finish Widget      |
| **Search**         | `Mod + F`         | All       | Focus search input (Media Gallery)       |
| **Select All**     | `Mod + A`         | All       | Select all items in current view         |
| **Open Library**   | `Mod + O`         | All       | Open Media Library (Upload Widget)       |
| **Help**           | `?`               | All       | Open hotkey cheatsheet                   |
