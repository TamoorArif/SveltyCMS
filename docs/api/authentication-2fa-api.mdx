...
- [Authentication System](/docs/dev-guide/01-authentication/authentication-system.mdx)
- [User Management API](/docs/dev-guide/api-user-token-management.md)
- [Security Plugin](/docs/dev-guide/security-plugin.mdx)
- [Cryptography Module](/docs/dev-guide/cryptography-module.mdx)
...
- `src/databases/auth/two-factor-auth.ts` - Service layer
