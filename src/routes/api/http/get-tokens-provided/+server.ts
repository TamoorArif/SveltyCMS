/**
 * @file src/routes/api/http/get-tokens-provided/+server.ts
...
// GET /api/http/get-tokens-provided - Returns which API tokens are currently configured (tenant-scoped)
