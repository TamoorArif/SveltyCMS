/**
 * @file src/routes/api/http/automations/[id]/+server.ts
...
/** GET /api/http/automations/:id — Get a single flow for the current tenant */
...
/** PATCH /api/http/automations/:id — Update a flow (tenant-scoped) */
...
/** DELETE /api/http/automations/:id — Delete a flow (tenant-scoped) */
