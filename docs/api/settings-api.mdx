...
| :--- | :--- | :--- |
| **Get Settings** | `GET /api/settings/[group]` | `locals.cms.system.getPreferences` |
| **Update Settings** | `POST /api/settings/update` | `locals.cms.system.setPreference` |
| **List All** | `GET /api/settings/all` | `locals.cms.system.settings.getAll` |
