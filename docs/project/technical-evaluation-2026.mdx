...
| Feature             | SveltyCMS (v2026)          | Strapi 5           | Payload 3.0        | Directus 11        |
| :------------------ | :------------------------- | :----------------- | :----------------- | :----------------- |
| **Core Framework**  | **Svelte 5 (Runes)**       | React              | Next.js / React    | Vue / Node.js      |
| **Multi-Tenancy**   | **Native Adapter-Level**   | Paid (Enterprise)  | Plugin-based       | Native             |
| **Slug Uniqueness** | **Tenant-Scoped (Native)** | Global Only        | Global Only        | Manual Config      |
| **AI Architecture** | **Local (Ollama) + Cloud** | Cloud Only (Paid)  | MCP Native (Cloud) | Cloud Only (Paid)  |
| **Real-time Sync**  | **CRDT (Yjs) over HTTP**   | WebSockets         | None / Custom      | WebSockets         |
| **RTL Detection**   | **Automated (Native)**     | Manual             | Manual             | Manual             |
| **SDK Latency**     | **Zero (Local In-Memory)** | 2–5ms (Local HTTP) | ~1ms (Direct)      | 3–8ms (Local HTTP) |
| **Toolchain**       | **VoidZero (Rust)**        | Vite (JS/TS)       | Vite (JS/TS)       | Vite (JS/TS)       |
