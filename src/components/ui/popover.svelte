...
@component
**Premium Svelte 5 Popover/Tooltip Primitive**

Native implementation using @floating-ui/dom for precise positioning.
Completely Skeleton-free.

### Props
- `position` (string): Placement of the popover ('top', 'bottom', 'left', 'right'). Default: 'bottom'.
- `arrow` (boolean): Whether to show an arrow indicator. Default: true.
- `trigger` (Snippet): The element that triggers the popover.
- `children` (Snippet): The content to display inside the popover.
-->
