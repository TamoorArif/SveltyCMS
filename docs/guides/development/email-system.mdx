---
path: "docs/guides/development/email-system.mdx"
...
- **[Automation System](./automation-system.mdx)**: Learn how to trigger emails based on CMS events.
- **[Webhooks API](../../api/Webhooks.mdx)**: For outbound events to third-party services.
- **[System Settings](../../api/settings-api.mdx)**: Manage SMTP credentials.
