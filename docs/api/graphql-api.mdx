...
The GraphQL API provides a powerful, flexible query language for accessing and manipulating data in SveltyCMS. It features dynamic schema generation based on your collections, widgets, and content structure, optimized with a Just-In-Time (JIT) execution engine.
...
const posts = await locals.cms.queryBuilder("posts")
...
> [!NOTE]
> For more details on WebSockets, see [GraphQL WebSocket Subscriptions](./graphql-websocket-subscriptions.mdx).
