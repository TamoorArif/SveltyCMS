...
// ... [scanCompiledFiles, getTypescriptAndJavascriptFiles, createOutputDirectories, extractHashFromJs, extractUUIDFromJs, cleanupOrphanedFiles remain exactly the same as your original code] ...
