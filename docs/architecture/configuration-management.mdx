...
<Callout type="info">
  **Example:** A developer adds a `MapboxWidget` to the codebase. This widget requires a
  `MAPBOX_API_KEY` to function, which is a secret stored as a System Setting in the database.
</Callout>
