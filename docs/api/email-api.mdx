...
- **Internal Access**: Used by the **[Automation System](../guides/development/automation-system.mdx)** to send notifications triggered by CMS events.
...
- **[Email System Guide](../guides/development/email-system.mdx)**: Conceptual overview and SMTP setup.
- **[Automation System](../guides/development/automation-system.mdx)**: Triggering emails automatically.
