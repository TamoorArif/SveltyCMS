/**
 * @file src/routes/api/http/icon-proxy/[...path]/+server.ts
 * @description
 ...
 *
 * **Usage:**
 * <img src="/api/http/icon-proxy/simpleicons/github" alt="GitHub" />
 * <img src="/api/http/icon-proxy/iconify/mdi:account" alt="Account" />
 *
 * @example
 * GET /api/http/icon-proxy/simpleicons/github
 * → Proxies to https://cdn.simpleicons.org/github
 *
 * GET /api/http/icon-proxy/iconify/mdi:account
...
const ALLOWED_PROVIDERS = {
  simpleicons: {
    ...
    // Maps: /api/http/icon-proxy/simpleicons/github → https://cdn.simpleicons.org/github
    transform: (path: string) => `${path}`,
  },
  iconify: {
    baseUrl: "https://api.iconify.design",
    // Maps: /api/http/icon-proxy/iconify/mdi:account → https://api.iconify.design/mdi/account.svg
