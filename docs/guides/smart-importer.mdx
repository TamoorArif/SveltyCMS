---
path: 'docs/guides/smart-importer.mdx'
title: 'Smart CMS Importer'
description: 'Guide to using the AI-powered external importer for migrating from WordPress and Drupal.'
order: 20
icon: 'mdi:import'
author: 'admin'
created: '2026-03-17'
...
sequenceDiagram
    ...
    User->>Adapter: Connect to Drupal/WP
    ...
    loop Batch Fetching
        Adapter->>Media: Extract Image URLs
...
- **Batch Processing**: Prevents server timeouts by processing items in chunks.
