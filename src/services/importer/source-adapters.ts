 ...
 */
export async function fetchDrupalData(url: string, type: string, apiKey?: string): Promise<ExternalSourceData> {
	try {
 ...
 */
export async function fetchWordPressData(url: string, type: string, apiKey?: string): Promise<ExternalSourceData> {
	try {
