...
>
> Tests authenticate like real users by calling `/api/auth/login` with seeded test credentials. This ensures the entire authentication and authorization pipeline is tested end-to-end.
